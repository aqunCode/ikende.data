...
namespace IKende.Data
{
    ...
    public abstract class ValidaterAttribute : Attribute
    {
        ...
        public bool Validating(object value, object source)
        {
            return OnValidating(value, source);
        ...
        /// <param name="cc">数据库上下文</param>
        /// <returns>bool</returns>
        protected abstract bool OnValidating(object value, object source);
        /// <summary>
        /// 验证返回的信息
        /// </summary>
    ...
    public class NotNull : ValidaterAttribute
    {
        ...
        /// <param name="cc">数据库上下文</param>
        /// <returns>bool</returns>
        protected override bool OnValidating(object value, object source)
        {
